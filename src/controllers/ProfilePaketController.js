...
const RadGroupReplayModel = require("../models/radiusd/radgroupreply.model");

const groupModel = require("../models/radiusd/profileGroupModel");
const { durationToSeconds } = require("../helpers/formatter");
...
class ProfilePaketController {
  ...
  static async storeHotspot(req, res) {
    try {
      ...
      // simpan ke radgroupreplay
      await RadGroupReplayModel.bulkCreate(values.groupname, [
        { attribute: "Session-Timeout", value: durationToSeconds(values.durasi) },
        { attribute: "Simultaneous-Use", value: values.shared_users },
        { attribute: "Port-Limit", value: values.shared_users },
        { attribute: "Mikrotik-Rate-Limit", value: values.speed_internet }
      ]);
  ...
  static async destroyHotspot(req, res) {
    try {
      ...
      await RadGroupReplayModel.deleteByGroupname(group.groupname);
