...
// default upload (dipakai di banyak route, misal product gambar)
const upload = multer({ dest: "uploads/" });

// khusus upload bukti PLN (pisah supaya folder lebih rapi)
...
// ROUTES TRANSAKSI PLN
router.get("/mgmn-pln/transaksi", ensureAuthenticated, ConPlnRoute.transaksi);
router.post("/mgmn-pln/transaksi/store", ensureAuthenticated, ConPlnRoute.transaksiStore);

// UPLOAD BUKTI (pakai uploadBukti middleware)
router.get("/mgmn-pln/upload-bukti", ensureAuthenticated, ConPlnRoute.uploadForm);
router.post("/mgmn-pln/upload-bukti", ensureAuthenticated, uploadBukti.single("bukti"), ConPlnRoute.uploadBukti);

// RIWAYAT / STRUK
router.get("/mgmn-pln/riwayat", ensureAuthenticated, ConPlnRoute.riwayat);
